...
def exploration():
    ...
    df_mob = load_data("/Users/Dieu/Documents/GitHub/LFB/streamlit-app/data/data_mob_2021.csv")
    df_inc = load_data("/Users/Dieu/Documents/GitHub/LFB/streamlit-app/data/data_inc_2021.csv")
    summary = load_data("/Users/Dieu/Documents/GitHub/LFB/streamlit-app/data/summary.csv")
