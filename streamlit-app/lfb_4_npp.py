...
def nettoyage():  # sourcery skip: extract-duplicate-method, inline-variable
    ...
    with _left:
        ...
        st.image(imgmap, width = 500, caption = "Les données géographiques : lieux d'incidents, casernes de départ...")
    with _mid:
        ...
        st.image(imgtime, width = 500, caption = "Les données temporelles : temps de trajet, date et heure d'appel...")
    with _right:
        imgmetier = "https://southwarknews.co.uk/wp-content/uploads/2021/10/stock-logo-ppe-1-london-fire-brigade.jpg"
        st.image(imgmetier, width = 500, caption = "Les données 'métier' : unités mobilisées, type d'intervention...")
